...
namespace TableProject
{
	class MainClass
	{
		...
		public static void Main (string[] args)
		{
			...
			table[0, (int)ti.ime] = "Георги"; table[0, (int)ti.familia] = "Крумов"; table[0, (int)ti.godini] = "71";

			
			//Въвеждане на втори ред
			table[1, (int)ti.ime] = "Крум"; table[1, (int)ti.familia] = "Георгиев"; table[1, (int)ti.godini] = "39";
